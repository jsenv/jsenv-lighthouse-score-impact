...
${renderFooter({ baseGist, afterMergeGist, pullRequestBase, pullRequestHead, runLink })}`
}
...
const renderFooter = ({ baseGist, afterMergeGist, pullRequestBase, runLink }) => {
  return `${
    baseGist
      ? `<sub>
...
<sub>
  Generated by <a href="https://github.com/jsenv/jsenv-lighthouse-score-impact">lighthouse score impact</a>${
    runLink ? ` during run <a href="${runLink.url}">${runLink.text}</a>` : ""
  }
</sub>`
}
